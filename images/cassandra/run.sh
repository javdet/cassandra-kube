...
echo 'JVM_OPTS="$JVM_OPTS -javaagent:'/jmx_prometheus_javaagent-0.2.0.jar=7070:/cassandra.yml'"' >> $CASSANDRA_CONF_DIR/cassandra-env.sh
...
chmod +rx /jmx_prometheus_javaagent-0.2.0.jar
chown cassandra /jmx_prometheus_javaagent-0.2.0.jar /cassandra.yml
